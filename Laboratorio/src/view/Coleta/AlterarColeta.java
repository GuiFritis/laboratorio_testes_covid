 ...
 * @author guilh
 */
public class AlterarColeta extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AlterarColeta
     */
    public AlterarColeta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        adicionarPaciente.setText("Alterar Coleta");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(adicionarPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(TFresponsavel, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void buttonConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConcluirActionPerformed
        ...
        try {
            ...
            Coleta coleta = new Coleta(1,
                ...
                TFcidade.getText(),
                this.coleta.getTipoMaterial(),
                pacientes.get(tablePacientes.getSelectedRow()),
                horario,
                this.coleta.getFormaColeta(),
                this.coleta.isSucesso(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarColeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlterarColeta dialog = new AlterarColeta(new javax.swing.JFrame(), true);
    ...
    private void preencherLabels(){               
        ...
        TFdia.setText(coleta.getDia());
        TFmes.setText(coleta.getMes());
        TFano.setText(coleta.getAno());
        TFhora.setText(coleta.getHora());
        TFminuto.setText(coleta.getMinuto());
        TFobservacoes.setText(coleta.getObservacao());
