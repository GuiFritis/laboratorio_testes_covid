 ...
 * @author guilh
 */
public class AdicionarRecoleta extends javax.swing.JDialog {

    private Coleta coleta;
    
    /**
     * Creates new form AdicionarRecoleta
     */
    public AdicionarRecoleta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        adicionarPaciente.setText("Adicionar Recoleta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarRecoleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdicionarRecoleta dialog = new AdicionarRecoleta(new javax.swing.JFrame(), true);
    ...
    public void preparar(Coleta coleta){
        this.coleta = coleta;        
    ...
    private void preencheLabels(){
        TFcidade.setText(coleta.getCidade());
        areaObservacoes.setText(coleta.getObservacao());
        TFresponsavel.setText(coleta.getProfissional());
        TFmaterial.setText(coleta.isSucesso()?
                "Necessita novo material":coleta.getTipoMaterial());
        dropFormaColeta.setSelectedItem(coleta.getFormaColeta());        
        if(coleta.isSucesso()){
    ...
    private void preencheFormaColeta(){
        DefaultComboBoxModel dfc = (DefaultComboBoxModel) dropFormaColeta.getModel();

        dfc.removeAllElements();

        for(EFormaColeta efc : EFormaColeta.values()){
            dfc.addElement(efc);
        }    
    }
    
    private void preenchePacientes(){
        DefaultTableModel tp = (DefaultTableModel) tablePacientes.getModel();         
            
        String[] linha = new String[2];
        linha[0] = this.coleta.getPaciente().getNome();
        linha[1] = this.coleta.getPaciente().getCpf();
